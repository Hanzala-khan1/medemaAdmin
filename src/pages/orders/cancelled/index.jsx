  ...
  const fetchData = async () => {
    ...
    if(localStorage.getItem("role")=="admin"){
      try {
        ...
        const querySnapshot = await  getDocs(query(dbRef,where("status", "==", "rejected")));
      ...
      try {
        ...
        const querySnapshot = await  getDocs(query(dbRef, where("receiverId", "==", localStorage.getItem("id")),where("status", "==", "rejected")));
