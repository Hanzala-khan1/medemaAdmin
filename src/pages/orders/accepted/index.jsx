  ...
  const fetchData = async () => {
    ...
    if(localStorage.getItem("role")=="admin"){
      try {
        ...
        const querySnapshot = await  getDocs(query(dbRef,where("status", "==", "accepted")));
      ...
      try {
        ...
        const querySnapshot = await  getDocs(query(dbRef, where("receiverId", "==", localStorage.getItem("id")),where("status", "==", "accepted")));
