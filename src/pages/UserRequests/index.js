  ...
  const Index = () => {
    ...
    let getuserdata = async () => {
      try {
        ...
        //   limit: 20, 
        // };
        let url = `${BASE_URL}/user/getInactiveUsers`;
        let body = {
          page: 1,
          limit: 20,
        }
    ...
    const ChangeBookingStatus = async (status, id) => {
        try {
          ...
          let url = `${BASE_URL}/user/UpdateuserStatus`;
          let body = {
            status: status,
            id: id,
          }
                ...
                items: [
                  {
                    label: (
                      <Button
                        ...
                        //   setEditData(true);
                        ChangeBookingStatus("active",record._id.toString())
                        }}
                      >
                        Approve
                      </Button>
                  ...
                  },
                  {
                    label: (
                      <Button
                        onClick={() => {
                            ChangeBookingStatus("blocked",record._id.toString())
                        }}
                        danger
                      >
                        Reject
    ...
    return (
      <div className="flex flex-col bg-white space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="font-semibold font-barlow text-2xl ml-6">Users Requests</h1>
          {/* <button
