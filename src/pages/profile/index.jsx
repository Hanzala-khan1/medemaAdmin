...
const Index = () => {
  ...
  let getUserData = async () => {
    try {
      ...
      let url = `${BASE_URL}/user/singleuser`;
      ...
      if (userInfo.data.userList) {
        console.log("mmmmmmmmmmmmmmmmmmmmmmmmmm",userInfo.data)
        setData(userInfo.data.userList);
      }
      else {
    ...
    <div className="" style={{ marginTop: "30px", }}>
      ...
      <div className="mt-[200px] w-[390px]">
        {data && <>
          ...
          <div >
            <h3 className="bg-blue-300 py-2  px-2 text-white">Name : {data.full_name ? data.full_name : "NA"} </h3>
